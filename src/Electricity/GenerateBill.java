...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            float cpu, mr, sc, st, sbc, ft;
            cpu = rs.getFloat("cost_per_unit");
            mr = rs.getFloat("meter_rent");
            sc = rs.getFloat("service_charge");
            st = rs.getFloat("service_tax");
            sbc = rs.getFloat("swacch_bharat_cess");
            ft = rs.getFloat("fixed_tax");
            
            float total_bill = 0;
            total_bill += cpu + mr + sc + st + sbc + ft;
            ...
            if(rs.next()){
                ...
                total_bill += rs.getFloat("total_bill");
                t1.append("\n---------------------------------------------------------------");
                t1.append("\n    TOTAL PAYABLE :\t"+total_bill);
            }
