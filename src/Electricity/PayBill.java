    ...
    PayBill(String meter){
        ...
        try{
            ...
            while(rs.next()){
                ...
                System.out.println(rs.getString("units")+rs.getString("total_bill")+ rs.getString("status"));
            }
            ...
            public void itemStateChanged(ItemEvent ae){
                try{
                    ...
                    while(rs.next()){
                        ...
                        l14.setText(rs.getString("total_bill"));
                        System.out.println(rs.getString("total_bill"));
                        l15.setText(rs.getString("status"));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            try{
                Conn c = new Conn();
               // String status = "Paid" ;
                c.s.executeUpdate("update bill set status = 'Paid' where meter_number = '"+meter+"' AND month = '"+c1.getSelectedItem()+"'");
                //System.out.println("yes!!!!!!!!!!!");
            }catch(Exception e){}
